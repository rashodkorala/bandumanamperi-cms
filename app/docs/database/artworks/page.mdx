...
- **price**: Artwork price
- **currency**: Currency code (USD, EUR, GBP, LKR)
- **price_upon_request**: Boolean flag to indicate price should be requested
- **collector_name**: Name of the collector who owns the artwork
